...
* Admin can create, read, update, delete (CRUD) maintenance hourly price, care features in both the caretaker's home and the dog owner's home, available reservation times.
