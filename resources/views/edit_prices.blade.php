...
.linkai{
                ...
                <div class="col-md-10">
                  <a href="{{ url('/add_prices') }}" class="btn btn-success btn-lg">Atgal</a>
                    ...
                    <div class="col" style="margin-top: 40px;">
                      <input value="{{ $prices->tipas }}" type="text" class="form-control" placeholder="Tipas" aria-label="tipas" id="tipas" name="tipas">
                    </div>
                    <div class="col" style="margin-top: 40px;">
                      <input value="{{ $prices->nurodyta_kaina }}" type="text" class="form-control" placeholder="Nurodyta kaina" aria-label="nurodyta_kaina" id="nurodyta_kaina" name="nurodyta_kaina">
                    </div>
    ...
    <footer>
        <div class="text-center p-3" style="background-image: linear-gradient(to right, #486A7C, #619BBA); margin-top: 500px;">© 2022 Darbą atliko Pijus Černiauskas</div>
    </footer>
