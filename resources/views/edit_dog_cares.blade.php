...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      ...
      <main>
        <div>
          <div class="d-flex justify-content-center">
            <div class="col-md-10">
              <h3 class="my-3 text-center" style="font-family: Impact; font-size: 50px; color:#5F9EA0;">Profilio redagavimas</h3>
              @if ($errors->any())
              ...
              @endif
                <form action="" method="POST" class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input value="{{ $Dog_care->vardas }}" type="text" class="form-control" id="vardas" name="vardas">
                  </div>
                  <div class="col-md-6">
                    <label for="pavarde" class="form-label" style="font-family: Impact; font-size: 20px;">Pavarde</label>
                    <input value="{{ $Dog_care->pavarde }}" type="text" class="form-control" id="pavarde" name="pavarde">
                  </div>
                  <div class="col-md-6">
                    <label for="telefono_numeris" class="form-label" style="font-family: Impact; font-size: 20px;">Telefono numeris</label>
                    <input value="{{ $Dog_care->telefono_numeris }}" type="text" class="form-control" id="telefono_numeris" name="telefono_numeris">
                  </div>
                  <div class="col-md-6">
                    <label for="adresas" class="form-label" style="font-family: Impact; font-size: 20px;">Adresas</label>
                    <input value="{{ $Dog_care->adresas }}" type="text" class="form-control" id="adresas" name="adresas">
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input value="{{ $Dog_care->suns_veisle }}" type="text" class="form-control" id="suns_veisle" name="suns_veisle">
                  </div>
                  <div class="col-md-6">
                    <label for="suns_amzius" class="form-label" style="font-family: Impact; font-size: 20px;">Šuns amžius</label>
                    <input value="{{ $Dog_care->suns_amzius }}" type="text" class="form-control" id="suns_amzius" name="suns_amzius">
                  </div>
                  <div class="col-md-6">
                    <label for="suns_svoris" class="form-label" style="font-family: Impact; font-size: 20px;">Šuns svoris (kg)</label>
                    <input value="{{ $Dog_care->suns_svoris }}" type="text" class="form-control" id="suns_svoris" name="suns_svoris">
                  </div>
                  <div class="col-md-6">
                    ...
                    <input value="{{ $Dog_care->draugiskas }}" type="text" class="form-control" id="draugiskas" name="draugiskas">
                  </div>
                  <div class="col-md-6">
                    <label for="alergiskas" class="form-label" style="font-family: Impact; font-size: 20px;">Ar alergiškas kam nors?</label>
                    <input value="{{ $Dog_care->alergiskas }}" type="text" class="form-control" id="alergiskas" name="alergiskas">
                  </div>
      ...
      <footer>
        <div class="text-center p-3" style="background-image: linear-gradient(to right, #486A7C, #619BBA); margin-top: 120px;">© 2022 Darbą atliko Pijus Černiauskas</div>
      </footer>
