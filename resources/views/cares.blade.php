...
.linkai{
        ...
        <main>
          <div class="container mt-4">
                <div class="d-flex justify-content-center">
                  <div class="col-md-10">
                      <h1 class="text-center p-4" style="font-family: Impact; font-size: 45px; color:#5F9EA0;">Paslaugos</h1>
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="card">
                            <div class="card-body">
                              <h5 style="font-family: Arial Black; font-size: 25px; text-align: center;  margin-top: 30px;" class="card-title">Šunų prižiūrėjimas prižiūrėtojo namuose</h5>
                              <div style="Adobe Garamond Pro Bold; font-size: 20px; margin-top: 30px;">
                              @forelse ($cares as $care)
                              @if($care->priziurejimas=="Prižiūrėtojo")
                                {{$care->uzsiemimas}}<br/>
                              @endif
                            @empty
                            ...
                            @endforelse
                              ...
                              <img src="/image/dogs4.png" style="margin-top: 50px;" class="card-img-top">
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="card">
                            <div class="card-body">
                              <h5 style="font-family: Arial Black; font-size: 25px; text-align: center;  margin-top: 30px;" class="card-title">Šunų prižiūrėjimas šuns savininko namuose</h5>
                              <div style="font-family: Adobe Garamond Pro Bold; font-size: 20px; margin-top: 30px;">
                              @forelse ($cares as $care)
                              @if($care->priziurejimas=="Savininko")
                                {{$care->uzsiemimas}}<br/>
                              @endif
                            @empty
                              <div>Paslaugos nenustatytos</div>
                            @endforelse
                              ...
                              <img src="/image/dogs5.png" style="margin-top: 40px;" class="card-img-top">
                            </div>
                          </div>
                        </div>                    
                      </div>
    ...
    <footer>
        <div class="text-center p-3" style="background-image: linear-gradient(to right, #486A7C, #619BBA); margin-top: 150px;">© 2022 Darbą atliko Pijus Černiauskas</div>
    </footer>
