    ...
    <main>
        <div class="container mt-4">
              <div class="d-flex justify-content-center">
                <div class="col-md-10">
                    <h1 class="text-center p-4" style="font-family: Impact; font-size: 50px; color:#5F9EA0;">Priežiūros kaina</h1>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <h5 style="font-family: Arial Black; font-size: 30px; text-align: center;  margin-top: 30px;" class="card-title">Šunų prižiūrėjimas prižiūrėtojo namuose</h5>
                          <div style="font-family: Adobe Garamond Pro Bold; font-size: 30px; text-align: center; margin-top: 30px;">
                            @forelse ($prices as $price)
                              @if($price->tipas=="Kaina_pri")
                                1 val kaina yra
                                {{$price->nurodyta_kaina}}
                                eurai.
                              @endif
                            @empty
                            ...
                            <img src="/image/dogs2.png" style="margin-top: 40px; margin-bottom: 105px;" class="card-img-top">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <h5 style="font-family: Arial Black; font-size: 30px; text-align: center; margin-top: 30px;" class="card-title">Šunų prižiūrėjimas šuns savininko namuose</h5>
                            <div style="font-family: Adobe Garamond Pro Bold; font-size: 30px; text-align: center; margin-top: 30px;">
                            @forelse ($prices as $price)
                              @if($price->tipas=="Kaina_sav")
                                1 val kaina yra
                                {{$price->nurodyta_kaina}}
                                eurai.
                              @endif
                            ...
                            <img src="/image/dogs3.png" style="margin-top: 40px;" class="card-img-top">
                            <div style="font-family: Arial Black; color:red; 30px; text-align: center; margin-top: 40px;">
                              <p>Atvykstu prižiūrėti jūsų šunų į jūsų namus tik, jeigu gyvenate Kaune</p>
                            </div>
                          </div>
                        </div>
                      </div>                    
