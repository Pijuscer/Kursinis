...
<div class="container mt-4">
    <a href="{{ url('/add_dog_care') }}" class="btn btn-success btn-lg">Atgal</a>
    <h1 class="text-center p-4" style="font-family: Impact; font-size: 50px; color:#5F9EA0;">Profilis</h1>
    <div>
    <form action="/dog_care/search" method="get">
    ...
    <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th scope="col">Šuns veislė</th>
            <th scope="col">Šuns amžius</th>
    ...
    @foreach ($DogCare as $DogCare2)
        <tr>
            ...
            <td>{{$DogCare2->adresas }}</td>
            <td>{{$DogCare2->suns_veisle }}</td>
            <td>{{$DogCare2->suns_amzius }}</td>
            <td>{{$DogCare2->suns_svoris }}</td>
            <td>{{$DogCare2->draugiskas }}</td>
            <td>{{$DogCare2->alergiskas }}</td>
            <td>{{ Str::limit($DogCare2->description, 50) }}</td>
            <td>
                <a class='no-underline' href="/dog_care/edit/{{$DogCare2->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"/>
                    <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"/>
                  </svg></a>
                <a class='no-underline' href="/dog_care/remove/{{$DogCare2->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
